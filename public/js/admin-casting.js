const QUESTION_LABELS = {
  ...
  q9: "¿Cómo reaccionás normalmente cuando estás bajo mucha presión?",
  q10: "¿Cuál considerás que es tu mayor fortaleza personal dentro de un grupo?",
  q11: "¿Cuál es tu mayor debilidad y cómo podría perjudicarte dentro del reality?",
  q12: "¿Qué rasgo de tu personalidad creés que podría generar conflicto con otros participantes?",
  q13: "¿Cómo actuás cuando tenés que convivir con alguien que no soportás?",
  q14: "Si una persona cercana dentro del reality amenaza tu juego, ¿priorizarías el vínculo o tu permanencia? Explicá.",
  q15: "¿Qué rol solés ocupar naturalmente dentro de un grupo?",
  q16: "¿Qué situación de convivencia sería la más capaz de sacarte de quicio?",
  q17: "¿Entrarías con una estrategia definida desde el principio o preferirías adaptarte sobre la marcha? ¿Por qué?",
  q18: "Descubrís que un aliado está planeando eliminarte. ¿Qué harías?",
  ...
  q22: "¿Qué secreto, información o ventaja intentarías guardar si supieras que podría cambiar el juego?",
  q23: "Si el resto empieza a verte como una amenaza, ¿cómo intentarías cambiar esa percepción?",
  q24: "¿Cómo reaccionarías si descubrís que alguien te estuvo manipulando para beneficiar su propio juego?",
  q25: "Si tuvieras que elegir, ¿preferirías ser querido o ser temido dentro del reality? Explicá.",
  q26: "¿Por qué querés participar de El Laboratorio?",
  q27: "¿Qué creés que aportarías al reality que otro postulante no podría aportar?",
  q28: "Imaginá que presenciás la primera eliminación del experimento. ¿Cómo creés que reaccionarías?",
  q29: "Imaginá que llegaste a la final. ¿Qué pensás que hiciste para conseguirlo?",
  q30: "Después de leer toda tu postulación, ¿qué es lo principal que querés que Producción recuerde de vos?",
};
